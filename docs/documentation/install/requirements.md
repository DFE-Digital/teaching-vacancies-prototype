...
This project is designed to work with Node.js version 22 LTS. It works with any 22.x.x version.
...
If it says another number, you need to download and install version 22.
